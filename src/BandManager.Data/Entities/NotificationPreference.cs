...
// needed.
// OutboundEmailCopy and everything after it appended, not reordered - see
// the ordinal note above, same reasoning applies to every value already in
// real use.
public enum NotificationKind { SongEditReviewed, GigReminder, RehearsalReminder, AvailabilityReminder, ResponsibilityChanged, OutboundEmailCopy, PayoutStatusChanged, ControlVisibilityChanged, Broadcast, ChatMention, DirectMessage }
