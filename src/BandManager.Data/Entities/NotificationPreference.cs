...
// real use.
public enum NotificationKind { SongEditReviewed, GigReminder, RehearsalReminder, AvailabilityReminder, ResponsibilityChanged, OutboundEmailCopy, PayoutStatusChanged, ControlVisibilityChanged }
